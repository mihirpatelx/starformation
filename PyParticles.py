...
def vectors((angle1, length1), (angle2, length2)):
...
def combine(p1, p2):
    if math.hypot(p1.x - p2.x, p1.y - p2.y) < p1.size + p2.size:
        ...
        (p1.angle, p1.speed) = vectors((p1.angle, p1.speed*p1.mass/total_mass), (p2.angle, p2.speed*p2.mass/total_mass))
...
def collide(p1, p2):
    ...
    if dist < p1.size + p2.size:
        ...
        (p1.angle, p1.speed) = vectors((p1.angle, p1.speed*(p1.mass-p2.mass)/total_mass), (angle, 2*p2.speed*p2.mass/total_mass))
        (p2.angle, p2.speed) = vectors((p2.angle, p2.speed*(p2.mass-p1.mass)/total_mass), (angle+math.pi, 2*p1.speed*p1.mass/total_mass))
...
class Particle:
    ...
    def accelerate(self, vector):
        (self.angle, self.speed) = vectors((self.angle, self.speed), vector)
